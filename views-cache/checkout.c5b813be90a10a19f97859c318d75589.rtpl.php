											...
											<table class="shop_table">
												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">× {$value.nrqtd</strong> 
														</td>
														<td class="product-total">
															<span class="amount"><?php echo formarPrice($value1["vltotal"]); ?></span>
														</td>
                                                    </tr>
                                                    <?php } ?>
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$<?php echo formarPrice($cart["vlsubtotal"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
														<td>
															R$<?php echo formarPrice($cart["vlfreight"]); ?>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$<?php echo formarPrice($cart["vltotal"]); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
